...
def determineNextMove (mazeWidth, mazeHeight, mazeMap, timeAllowed, playerLocation, opponentLocation, coins) :
    global last_move, last_pos
    nextMove = MOVEMENTS[(MOVEMENTS.index(last_move) - 1) % 4] if last_pos == playerLocation else MOVEMENTS[(MOVEMENTS.index(last_move) + 1) % 4]
        
    last_pos, last_move = playerLocation, nextMove
    return nextMove
